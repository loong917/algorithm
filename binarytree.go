...
func (tree *BinaryTree) Delete(data int) {
	...
	// 要删除的节点有2个子节点
	// 首先查找删除节点的后继节点，即删除节点右子树中最小的节点；
	// 然后将删除节点后继节点的值覆盖删除节点，并将后继节点的右子树挂载到后继节点的父节点上；
...
// 前序遍历
// 前序遍历是指对于树中的任意节点来说，先打印这个节点，然后再打印它的左子树，最后打印它的右子树
...
// 中序遍历
// 中序遍历是指对于树中的任意节点来说，先打印它的左子树，然后再打印它本身，最后打印它的右子树
...
// 后序遍历
// 后序遍历是指对于树中的任意节点来说，先打印它的左子树，然后再打印它的右子树，最后打印这个节点本身
